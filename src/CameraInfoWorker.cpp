...
void CameraInfoWorker::OnOK()
{
    ...
    m_VehicleData.Set("m_iRaceNum", data.m_VehiclesInfo.m_VehicleData.m_iRaceNum);
    m_VehicleData.Set("m_szName", GetStringFromChar(data.m_VehiclesInfo.m_VehicleData.m_szName));
    m_VehicleData.Freeze();
    m_VehiclesInfo.Set("m_VehicleData", m_VehicleData);
